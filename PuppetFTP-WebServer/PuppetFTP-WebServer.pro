...
SOURCES     += src/component/renderer/EmptyPageRenderer.cpp
...
SOURCES     += src/component/server/ServerAnonConfEditor.cpp
...
SOURCES     += src/component/widget/special/Information.cpp
...
SOURCES     += src/component/Translate.cpp
...
SOURCES     += src/request/processor/module/server/ServerManageProcessor.cpp
...
SOURCES     += src/request/Context.cpp
...
HEADERS     += src/daemon/Daemon.h
HEADERS     += src/component/renderer/EmptyPageRenderer.h
...
HEADERS     += src/component/widget/special/Information.h
...
HEADERS     += src/component/server/ServerAnonConfEditor.h
...
HEADERS     += src/component/Translate.h
...
HEADERS     += src/request/processor/module/server/ServerManageProcessor.h
